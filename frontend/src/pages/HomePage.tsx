    ...
    >
      ...
      <header className="mx-auto flex min-h-[80svh] w-full max-w-6xl items-center pt-8 sm:pt-14">
        ...
        >
          ...
          >
            Turn every scroll into a stage and every practice into progress.
          </h1>
          <p
            id="landing-description"
            className="mt-5 max-w-2xl text-base text-light/85 sm:text-lg lg:text-xl"
          >
            Experience a cinematic, immersive practice journey with scroll-linked
            depth, guided learning steps, and actionable vocal feedback.
          </p>
